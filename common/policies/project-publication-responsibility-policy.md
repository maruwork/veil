...
The goal is to prevent project担当者 and 共通管理側 from assuming different responsibility splits.
...
- preparation: `project担当者`
- review: `共通管理側`
- public release execution: `共通管理側`

Reason:

- public release is the highest-risk irreversible step
- project担当者 has stronger repository-local context
- 共通管理側 has stronger cross-project publication discipline
...
- preparation: `project担当者`
- review: `共通管理側`
- public release execution: `project担当者`
...
1. project担当者 publishes without shared review when shared tools affect the release surface
2. 共通管理側 rewrites repository-local structure without project shelf rules
...
This record may live in the project-local adoption packet, public release packet, or another explicit governance document for the project.
