...
・AIが勝手に決めた英語や造語が混入し、読み返すたびに理解が止まる
・直しても次のセッションでまた戻る
・作成したファイルが汚染される

AI利用が日常化するほど、この問題は増えます。VEILはAIが使った語彙を捕捉し、ユーザーが採用語を決めて記録することで、最初から出ないようにします。動作は語彙登録時と自分から呼んだときだけ。依存ゼロ、ローカル完結。リポジトリをどこにクローンし直しても語彙ルールは残り、壊れても再構成できます。
